...
- 다국어 인덱스: [docs/i18n/README.i18n.md](docs/i18n/README.i18n.md)
...
- 지원 언어(18): `ko`, `ja`, `zh_Hans`, `zh_Hant`, `de`, `fr`, `es`, `it`, `pt_BR`, `ru`, `uk`, `vi`, `th`, `id`, `tr`, `pl`, `nl`, `ar`
- LuCI 시스템 언어를 해당 언어로 바꾸면 메뉴/설정 문구가 번역됩니다.
